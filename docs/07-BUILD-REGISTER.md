# Programme Build Register

This is the working production list for the complete Kydos Digital Agency Business-in-a-Box.

## Phase 1, Foundation

- [x] Master Programme Plan
- [x] Kydos Source of Truth
- [x] Programme Tiers
- [x] 4-Week Launch Roadmap
- [x] Service Pricing Template
- [x] Operating Model
- [x] Policies and Contracts Register
- [x] Build Register
...
- [x] Convert calculators/trackers to styled XLSX workbooks, finance/operations and content/ads/SEO workbooks created and visually QA checked
