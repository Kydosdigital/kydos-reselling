...
export const metadata: Metadata = {
  ...
  description: "Practical guides on starting, pricing, staffing, selling and operating a UK digital marketing agency, written from the Kydos Digital operating model.",
  alternates: { canonical: "/blog" },
  openGraph: {
    title: "Digital Marketing Agency Guides UK | Kydos Academy",
    description: "Practical guides for building, selling and operating a UK digital marketing agency.",
    url: "/blog",
    type: "website"
  }
};
      ...
      <main>
        <section className="subpage-hero blog-hero">
          <div className="container narrow centred">
            ...
            <h1>How to build, sell and operate a UK digital marketing agency.</h1>
            <p className="hero-copy">
              Practical guidance on company setup, pricing, CRM, sales, staffing, client delivery and acquisition,
              based on the operating systems behind Kydos Digital.
            </p>
            <div className="blog-topic-strip" aria-label="Guide topics">
        ...
        <section className="section blog-index-section">
          <div className="container">
            <div className="blog-index-intro">
              <div>
                <span className="eyebrow">{blogArticles.length} practical guides</span>
                <h2>Start with the problem you are solving now.</h2>
              </div>
              <p>
                These guides are deliberately connected. Start with the UK agency setup guide, then move into pricing,
                sales, CRM, onboarding, SOPs and the management structure needed as the business grows.
              </p>
            </div>
        ...
        <section className="final-cta">
          <div className="container final-cta-inner">
            <div>
              <span className="eyebrow">Want more than articles?</span>
              <h2 style={{ marginTop: 14 }}>Build the operating system with Kydos.</h2>
              <p>The Academy turns the guidance into templates, processes, systems and implementation support.</p>
            </div>
